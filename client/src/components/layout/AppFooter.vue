      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p class="text-gray-400 text-sm">
            Your trusted platform for event tickets and unforgettable experiences.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li><RouterLink to="/events" class="text-gray-400 hover:text-white">Browse Events</RouterLink></li>
            ...
            <li><RouterLink to="/auth/register?role=organizer" class="text-gray-400 hover:text-white">Become Organizer</RouterLink></li>
          </ul>
        </div>
          ...
          <div v-if="!subscribed">
            <div class="flex">
              ...
              <button 
                ...
                class="btn-primary btn-sm rounded-l-none"
              >
                Subscribe
              </button>
            </div>
          </div>
          <div v-else class="bg-green-100 text-green-800 px-4 py-2 rounded-lg text-sm">
