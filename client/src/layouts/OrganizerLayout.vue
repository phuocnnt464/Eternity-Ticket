...
const isActive = (item) => {
  if (item.exact) {
    // Exact match: /organizer/events should NOT match /organizer/events/create
    return route.path === item.href
  } else {
    // Prefix match: /organizer/dashboard matches /organizer/dashboard/*
