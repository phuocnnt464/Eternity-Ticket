...
('concurrent_purchase_limit', '100', 'Default concurrent purchase limit', false),
('queue_timeout_minutes', '15', 'Default queue timeout in minutes', false)
...
UPDATE users
SET password_hash = crypt('Eternity@123', gen_salt('bf'));

UPDATE users
SET password_hash = crypt('admin123', gen_salt('bf')),
    updated_at = NOW()
WHERE email = 'adminSystem@eternityticket.com';
